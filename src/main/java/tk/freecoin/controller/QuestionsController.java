...
public class QuestionsController {
	...
	/*
	 * @GetMapping(value =
	 * "/addQuestions/{quiz}/{question}/{choice1}/{choice2}/{choice3}/{choice4}/{answer}/",
	 * produces = MediaType.APPLICATION_JSON_VALUE) public void
	 * addQuestions(@PathVariable("quiz") int quiz,
	 * 
	 ...
	 * 
	 * Questions questions = new Questions(quiz, question, choice1, choice2,
	 * choice3, choice4, answer); questionsDao.save(questions); }
	 * 
	 * @GetMapping(value =
	 * "/updateQuestions/{questions_id}/{quiz}/{question}/{choice1}/{choice2}/{choice3}/{choice4}/{answer}/",
	 * produces = MediaType.APPLICATION_JSON_VALUE) public void
	 * update_Questions(@PathVariable("questions_id") int questions_id,
	 * 
	 ...
	 * questions.setQuiz(quiz); questions.setQuestion(question);
	 * questions.setChoice1(choice1); questions.setChoice2(choice2);
	 * questions.setChoice3(choice3); questions.setChoice4(choice4);
	 * questions.setAnswer(answer); questionsDao.save(questions); }
	 * 
	 * @GetMapping(value = "/deleteQuestions/{questions_id}/", produces =
	 * MediaType.APPLICATION_JSON_VALUE) public void
	 * delete_Questions(@PathVariable("questions_id") int questions_id) {
	 * 
	 * Questions questions = questionsDao.findByQuestionsid(questions_id);
